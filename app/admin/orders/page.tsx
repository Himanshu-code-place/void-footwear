...
//         <div>
//           <p className="uppercase tracking-[0.3em] text-xs text-black">
//             Admin Orders
//           </p>
...
//                   <p className="text-black mt-1">{order.userEmail}</p>
//                 </div>
...
//                   <p className="font-medium mt-1">{order.city}</p>
//                 </div>

//                 <div>
//                   <p className="text-black">State</p>

//                   <p className="font-medium mt-1">{order.state}</p>
//                 </div>
...
//                 <p className="mt-2 font-medium">{order.address}</p>
//               </div>
//             </div>
//           ))}
//         </div>
